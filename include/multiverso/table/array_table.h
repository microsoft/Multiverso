...
public:
  ...
  explicit ArrayWorker(const ArrayTableInitOption &option);
...
public:
  ...
  explicit ArrayServer(const ArrayTableInitOption& option);
...
DEFINE_TABLE_TRAIT_WITH_INIT_OPTION(ArrayTableInitOption, ArrayWorker, ArrayServer);
