...
import org.apache.hadoop.yarn.applications.zmq.am.ApplicationMaster;
...
public class Client {
  ...
  // RM/ASM
  private String appName = "multiverso_zmq";
  // App master priority
  ...
  public Client(Configuration conf) throws Exception {
    this("org.apache.hadoop.yarn.applications.zmq.am.ApplicationMaster", conf);
  }
  ...
  public boolean init(String[] args) throws ParseException {
    ...
    appName = cliParser.getOptionValue(DSConstants.OPT_APPNAME, "multiverso_zmq");
  ...
  public boolean run() throws IOException, YarnException {
    ...
    if (isVerboseOn) {
      ...
      LOG.info("Got Cluster metric info from ASM" + ", numNodeManagers="
        ...
        LOG.info("Got Cluster node info from ASM"); for (NodeReport node :
        clusterNodeReports) { LOG.info("Got node report from ASM for" +
        ", nodeId=" + node.getNodeId() + ", nodeAddress" +
        node.getHttpAddress() + ", nodeRackName" + node.getRackName() +
