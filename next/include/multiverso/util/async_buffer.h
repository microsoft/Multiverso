...
namespace multiverso {
    ...
    public:
        ASyncBuffer(BufferType& buffer0, BufferType& buffer1, std::function<void(BufferType&)> fill_buffer_func)
            : buffer0_{ buffer0 }, buffer1_{ buffer1 }, fill_buffer_func_{ fill_buffer_func }, ready_waiter_{ 0 }, new_task_waiter_{ 1 }, current_task_(FILL_BUFFER1){
